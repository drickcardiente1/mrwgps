...
class UserManager(BaseUserManager):
    ...
    def _create_user(
        ...
        **kwargs
        ...
        user = self.model(
            username=username, email=email, first_name=first_name,last_name = last_name, type=type, mobile=mobile, **kwargs
        )
    ...
    def create_user(
        ...
        **kwargs
        ...
        return self._create_user(username, email, password, first_name, last_name, RENTER, mobile, **kwargs)

    def create_superuser(self,username: str,email: str,password: str,first_name: str, last_name: str,mobile: Optional[str] = None,**kwargs):
        """
        ...
        return self._create_user(username, email, password, first_name, last_name, ADMIN, mobile, **kwargs)
